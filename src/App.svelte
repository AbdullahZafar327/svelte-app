<script>
  ...
  async function loadMenu() {
    const response = await fetch('https://svelte-backend-xqxj.onrender.com/v1/menu');
    menu = await response.json();
  }

  async function loadReservations() {
    const response = await fetch('https://svelte-backend-xqxj.onrender.com/v1/reservations');
    reservations = await response.json();
  }

  async function submitOrder() {
    const response = await fetch('https://svelte-backend-xqxj.onrender.com/v1/orders', {
      method: 'POST',
  ...
  async function submitContact() {
    const response = await fetch('https://svelte-backend-xqxj.onrender.com/v1/contact', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
